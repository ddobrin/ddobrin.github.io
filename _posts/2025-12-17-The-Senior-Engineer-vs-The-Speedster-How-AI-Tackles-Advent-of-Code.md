...
This year, having early access to Gemini 3 Pro and Flash, I decided to take a totally different approach to solving these puzzles: delegate to Gemini models and run an experiment that combines the creative puzzles of Advent of Code with the power of state-of-the-art LLMs. I was curious of the results, with different models tested. 

## TL;DR
**A Focused Goal**
- use state-of-the-art models: _**[Gemini 3 Pro Preview](https://ai.google.dev/gemini-api/docs/models#gemini-3-pro)**_ and _**[Gemini 3 Flash Preview](https://ai.google.dev/gemini-api/docs/models#gemini-3-flash)**_
...
- compare not just _**whether**_ the models solve it, but _**how**_ they solve it, as a follow-up
...
- why this exercise? Imagine what you can do with this exercise with optimization, human-in-the-loop, software engineering principles guidance, etc !!!

![Image1]({{ '/assets/images/aoc.png' | relative_url }})
...
### Advent of Code: Packing Serious Challenges as Personal Developer Fun
...
| **Graduated difficulty** | Days 1-6 focus more on basic reasoning; <br> Days 7-12 reveal which models understand complex algorithms |
| **Logical focus** | focus on solving a problem in a logical way, no distraction <br> from using frameworks or libraries in the code |
| **Flexibility** | Implement in the programming language of your choice |
| **Multi-dimensional evaluation** | You can assess correctness, code quality, performance, <br> explanation clarity, and debugging ability all at once |
| **Real-world-like** | Unlike small demo challenges, Advent of Code requires parsing <br> varied and messy input, handling edge cases, and sometimes optimizing for scale |
...
|-------|---------|-------------------|
| **Gemini 3 Pro Preview** | "The Senior Engineer" | Robust, maintainable, production-ready code. <br> Proper error handling, modern APIs, clean architecture |
| **Gemini 3 Flash Preview** | "The Speedster" | Get the right answer *fast*. <br> Correct logic, but less emphasis on "gold plating" or defensive coding |
...
I used a hybrid approach, and this is just a guideline - **remember** that we used minimalistic prompting and have not looked into optimizations!
...
| Metric | Senior (Pro 3) | Speedster (Flash 3) |
|--------|--------------|-------------------|
...
Gemini 3 Flash acted like a developer racing against a deadline: it got the right answer efficiently, but left behind some technical debt. Hardcoded values, older APIs, silent error handling—these are the hallmarks of "I'll fix it later" code that often takes time or never gets fixed.
...
- **Gemini Flash** delivered a working solution with minimal fuss, but left some technical debt
